 ...
 */
public class UpdateProjectileMessage extends IncomingMessage {
    private final static String PREFIX = "UPDATE_PROJECTILE";
    private final int id;
    private final double x;
    private final double y;
    
    public UpdateProjectileMessage(int id,double x,double y) {
        this.id = id;
        this.x = x;
        this.y = y;
    }
    ...
    public static UpdateProjectileMessage convertStringToMessage(String string) {
        try {
            ...
            return new UpdateProjectileMessage(id,x,y);
        } 
