 ...
 */
public class RemoveLaserMessage extends IncomingMessage {

    private final static String PREFIX = "REMOVE_LASER";
    private final int id;
    
    public RemoveLaserMessage(int id) {
        this.id = id;
    }
    ...
    public static RemoveLaserMessage convertStringToMessage(String string) {
        try {
            ...
            return new RemoveLaserMessage(id);
        } 
